...
public class Steal_Depot_Bump extends AutoRoutineBase {
    public Steal_Depot_Bump(){
        super("Steal_Depot_Bump");

        AutoTrajectory traj1 = getTrajectory("Steal_Depot_Bump",0);
        AutoTrajectory traj2 = getTrajectory("Steal_Depot_Bump",1);
