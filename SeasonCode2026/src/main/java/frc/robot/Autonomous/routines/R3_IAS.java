 ...
 */
        ...
        traj1.atTime("Score1").onTrue(CatzSuperstructure.Instance.toggleCmdHubShoot());
        ...
        traj2.atTime("Score2").onTrue(CatzSuperstructure.Instance.toggleCmdHubShoot());
        ...
        traj4.atTime("StopIntake+Score4").onTrue(CatzIntakeRoller.Instance.setpointCommand(IntakeRollerConstants.OFF_SETPOINT)
                                                   .alongWith(CatzSuperstructure.Instance.toggleCmdHubShoot()));
