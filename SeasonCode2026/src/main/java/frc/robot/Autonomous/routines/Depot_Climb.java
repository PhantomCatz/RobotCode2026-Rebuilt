...
public class Depot_Climb extends AutoRoutineBase{
    public Depot_Climb(){
        ...
        traj3.atTime("RampUp+StopIntake3").onTrue(CatzSuperstructure.Instance.trackTargetAndRampUp(RegressionMode.HUB).alongWith(Commands.print("RampUp+StopIntake3"))
