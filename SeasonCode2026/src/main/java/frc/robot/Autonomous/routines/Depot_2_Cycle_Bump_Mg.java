...
public class Depot_2_Cycle_Bump_Mg extends AutoRoutineBase {
    public Depot_2_Cycle_Bump_Mg(){
        super("Depot_2_Cycle_Bump_Mg");

        AutoTrajectory traj1 = getTrajectory("Depot_2_Cycle_Bump_Mg",0);
        AutoTrajectory traj2 = getTrajectory("Depot_2_Cycle_Bump_Mg",1);
        AutoTrajectory traj3 = getTrajectory("Depot_2_Cycle_Bump_Mg",2);
        AutoTrajectory traj4 = getTrajectory("Depot_2_Cycle_Bump_Mg",3);
        AutoTrajectory traj5 = getTrajectory("Depot_2_Cycle_Bump_Mg",4);
