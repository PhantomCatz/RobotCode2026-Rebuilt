...
public class Outpost_2_Cycle extends AutoRoutineBase {
    public Outpost_2_Cycle(){
        ...
        AutoTrajectory traj8 = getTrajectory("Outpost_2_Cycle",7);
        AutoTrajectory traj9 = getTrajectory("Outpost_2_Cycle",8);
        AutoTrajectory traj10 = getTrajectory("Outpost_2_Cycle",9);
        AutoTrajectory traj11 = getTrajectory("Outpost_2_Cycle",10);
