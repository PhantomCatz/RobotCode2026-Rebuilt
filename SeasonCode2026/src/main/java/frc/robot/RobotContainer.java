...
xboxAux.rightBumper().onTrue(manualCommandSwitch(true));
        
          xboxAux.a().onTrue(superstructure.hoodManualCommand());
          xboxAux.b().onTrue(superstructure.flywheelManualCommand());
          xboxAux.y().onTrue(superstructure.turretManualCommand());
          xboxAux.x().onTrue(superstructure.stopAllShooting());
    ...
    public static Command manualCommandSwitch(boolean manualCommandSwitch) {
        xboxAux.rightTrigger().onTrue(superstructure.manualCommandSwitch());
      }  
