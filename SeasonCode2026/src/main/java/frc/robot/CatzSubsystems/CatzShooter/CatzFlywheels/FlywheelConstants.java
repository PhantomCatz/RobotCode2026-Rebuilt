...
public class FlywheelConstants {
    ...
    public static final Gains gains = switch (CatzConstants.getRobotType()) {
		...
		case SN2 -> new Gains(0.5000, 0.0, 0.0, 0.0, 0.1464, 0.0, 0.0); //with duty cycle: p=0.05, v=0.0122
    ...
    public static final LoggedTunableNumber SHOOTING_RPS_TUNABLE = new LoggedTunableNumber("Flywheels/EjectingRps", 40.0);
