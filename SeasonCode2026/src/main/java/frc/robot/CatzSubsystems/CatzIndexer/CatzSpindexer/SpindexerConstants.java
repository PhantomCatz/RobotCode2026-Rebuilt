...
public class SpindexerConstants {
	public static final Setpoint ON = Setpoint.withVoltageSetpoint(12.0);
	...
	public static final LoggedTunableNumber SPEED = new LoggedTunableNumber("Spindexer/Spede");
