...
// store the shooting commands so we can check their active state
    ...
    xboxAux.button(Gamepad.Button.EAST_FACE).onTrue(CatzSuperstructure.Instance.toggleIntakeRollers());
    xboxAux.button(Gamepad.Button.WEST_FACE).onTrue(CatzSuperstructure.Instance.toggleSpindexer());
